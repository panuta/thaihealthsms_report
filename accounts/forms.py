...
class UserProfileForm(forms.Form):
    firstname = StrippedCharField(max_length=200, widget=forms.TextInput(attrs={'class':'span7'}))
    lastname = StrippedCharField(max_length=200, widget=forms.TextInput(attrs={'class':'span7'}))